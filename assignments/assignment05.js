...
function loadContent() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 
     ...
     ConfirmedOver100000 = []
      ConfirmedOver100000 = _.sortBy(newConfirmedOver1000, "TotalConfirmedPer100000").reverse();
      ...
      chartData.data.labels  
        = ConfirmedOver100000.map( (x) => x.Slug );
      chartData.data.datasets[0].data  
        = ConfirmedOver100000.map( 
          (x) => x.TotalConfirmed );
      ...
      chartData.options.title.text 
        = "Covid 19 Hotspots " + now.toString();
